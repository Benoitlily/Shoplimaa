...
--custom-color-1: #e16503;
--custom-color-1-darker: #cb5b03;
--custom-color-1-r: 225;
--custom-color-1-g: 101;
--custom-color-1-b: 3;
--custom-color-1-contrast: white;
--custom-color-1-contrast-darker: white;
--custom-color-1-text-color: var(--body-alt-color);
--custom-color-2: #f2f603;
--custom-color-2-darker: #dadd03;
--custom-color-2-r: 242;
--custom-color-2-g: 246;
--custom-color-2-b: 3;
--custom-color-2-contrast: black;
--custom-color-2-contrast-darker: black;
--custom-color-2-text-color: var(--body-color);
--custom-color-3: #d66003;
--custom-color-3-darker: #c15603;
...
--custom-color-4: #a74b02;
--custom-color-4-darker: #964302;
--custom-color-4-r: 167;
--custom-color-4-g: 75;
--custom-color-4-b: 2;
